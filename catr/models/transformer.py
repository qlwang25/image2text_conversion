...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, pos_embed, tgt, tgt_mask):
        ...
        query_embed = query_embed.repeat(1, bs, 1)  # vocab_size * bs * hidden_num
        ...
        return hs, memory, pos_embed, query_embed  # add: return memory and embeds here
...
class DecoderEmbeddings(nn.Module):
    ...
    def forward(self, x, input_embeds=None):
        ...
        if input_embeds is None:
            # If the specified embedding is not passed in, the default is embedding(x)
